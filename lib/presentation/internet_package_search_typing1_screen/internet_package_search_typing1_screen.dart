import '../internet_package_search_typing1_screen/widgets/listvaadintimebac2_item_widget.dart';
import 'controller/internet_package_search_typing1_controller.dart';
import 'models/listvaadintimebac2_item_model.dart';
import 'package:feri_s_application1/core/app_export.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class InternetPackageSearchTyping1Screen
    extends GetWidget<InternetPackageSearchTyping1Controller> {
  @override
                    ...
                    child: Obx(
                      () => ListView.builder(
                        ...
                        itemCount: controller
                            .internetPackageSearchTyping1ModelObj
                            .value
                            .listvaadintimebac2ItemList
                            .length,
                        itemBuilder: (context, index) {
                          Listvaadintimebac2ItemModel model = controller
                              .internetPackageSearchTyping1ModelObj
                              .value
                              .listvaadintimebac2ItemList[index];
                          return Listvaadintimebac2ItemWidget(
                            model,
                          );
                        },
                      ),
