...
class Listinternet2ItemWidget extends StatelessWidget {
  Listinternet2ItemWidget(this.listinternet2ItemModelObj,
      {this.onTapColumninternet});

  Listinternet2ItemModel listinternet2ItemModelObj;
