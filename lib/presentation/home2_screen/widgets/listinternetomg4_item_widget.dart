...
class Listinternetomg4ItemWidget extends StatelessWidget {
  Listinternetomg4ItemWidget(this.listinternetomg4ItemModelObj);

  Listinternetomg4ItemModel listinternetomg4ItemModelObj;

  var controller = Get.find<Home2Controller>();
