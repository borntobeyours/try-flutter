...
class Listfilesize1ItemWidget extends StatelessWidget {
  Listfilesize1ItemWidget(this.listfilesize1ItemModelObj);

  Listfilesize1ItemModel listfilesize1ItemModelObj;
