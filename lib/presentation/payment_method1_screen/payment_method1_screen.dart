import '../payment_method1_screen/widgets/payment_method1_item_widget.dart';
import 'controller/payment_method1_controller.dart';
import 'models/payment_method1_item_model.dart';
import 'package:feri_s_application1/core/app_export.dart';
import 'package:flutter/material.dart';
import 'package:flutter_svg/flutter_svg.dart';

class PaymentMethod1Screen extends GetWidget<PaymentMethod1Controller> {
  @override
                                          ...
                                          Padding(
                                              ...
                                              child: Obx(() => ListView.builder(
                                                  ...
                                                  itemCount: controller
                                                      .paymentMethod1ModelObj
                                                      .value
                                                      .paymentMethod1ItemList
                                                      .length,
                                                  itemBuilder:
                                                      (context, index) {
  ...
  onTapBtnKonfirmasiba() {
    Get.toNamed(AppRoutes.successTransaction1Screen);
  }
}
