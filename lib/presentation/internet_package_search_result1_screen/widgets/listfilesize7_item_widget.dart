...
class Listfilesize7ItemWidget extends StatelessWidget {
  Listfilesize7ItemWidget(this.listfilesize7ItemModelObj);

  Listfilesize7ItemModel listfilesize7ItemModelObj;

  var controller = Get.find<InternetPackageSearchResult1Controller>();
