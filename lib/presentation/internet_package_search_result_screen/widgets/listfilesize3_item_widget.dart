...
class Listfilesize3ItemWidget extends StatelessWidget {
  Listfilesize3ItemWidget(this.listfilesize3ItemModelObj,
      {this.onTapCardPackage});

  Listfilesize3ItemModel listfilesize3ItemModelObj;

  var controller = Get.find<InternetPackageSearchResultController>();

  VoidCallback? onTapCardPackage;
                            ...
                            children: [
                              ...
                              Padding(
                                ...
                                child: Text(
                                  ...
                                  style: AppStyle.textstylegooglesansbold12
                                      .copyWith(
                                    fontSize: getFontSize(
                                      12,
                                    ),
                      ...
                      children: [
                        Padding(
                          ...
                          child: Text(
                            ...
                            textAlign: TextAlign.left,
                            style:
                                AppStyle.textstylegooglesansregular12.copyWith(
                              fontSize: getFontSize(
                                12,
                              ),
                              height: 1.33,
