...
class Listinternetomg1ItemWidget extends StatelessWidget {
  Listinternetomg1ItemWidget(this.listinternetomg1ItemModelObj);

  Listinternetomg1ItemModel listinternetomg1ItemModelObj;
