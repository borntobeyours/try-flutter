...
class Listfilesize4ItemWidget extends StatelessWidget {
  Listfilesize4ItemWidget(this.listfilesize4ItemModelObj,
      {this.onTapColumnfilesize});

  Listfilesize4ItemModel listfilesize4ItemModelObj;
