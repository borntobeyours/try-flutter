...
class Listfilesize5ItemWidget extends StatelessWidget {
  Listfilesize5ItemWidget(this.listfilesize5ItemModelObj);

  Listfilesize5ItemModel listfilesize5ItemModelObj;
