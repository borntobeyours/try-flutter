...
class Listinternetomg3ItemWidget extends StatelessWidget {
  Listinternetomg3ItemWidget(this.listinternetomg3ItemModelObj);

  Listinternetomg3ItemModel listinternetomg3ItemModelObj;
