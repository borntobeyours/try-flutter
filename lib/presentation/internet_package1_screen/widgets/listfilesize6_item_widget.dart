...
class Listfilesize6ItemWidget extends StatelessWidget {
  Listfilesize6ItemWidget(this.listfilesize6ItemModelObj);

  Listfilesize6ItemModel listfilesize6ItemModelObj;

  var controller = Get.find<InternetPackage1Controller>();
