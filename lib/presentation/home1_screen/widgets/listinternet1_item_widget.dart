...
class Listinternet1ItemWidget extends StatelessWidget {
  Listinternet1ItemWidget(this.listinternet1ItemModelObj,
      {this.onTapColumninternet});

  Listinternet1ItemModel listinternet1ItemModelObj;
