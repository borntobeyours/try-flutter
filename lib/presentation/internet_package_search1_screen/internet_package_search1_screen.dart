import '../internet_package_search1_screen/widgets/listvaadintimebac3_item_widget.dart';
...
class InternetPackageSearch1Screen
    extends GetWidget<InternetPackageSearch1Controller> {
  @override
                                  ...
                                  child: Stack(
                                    ...
                                    children: [
                                      Align(
                                        alignment: Alignment.centerLeft,
                                        child: Text(
                                          "msg_cari_paket_favo".tr,
                                          overflow: TextOverflow.ellipsis,
                                          textAlign: TextAlign.left,
                                          style: AppStyle
                                              .textstylegooglesansmedium14
                                              .copyWith(
                  ...
                  Padding(
                    ...
                    child: Obx(
                      () => ListView.builder(
                        ...
                        shrinkWrap: true,
                        itemCount: controller.internetPackageSearch1ModelObj
                            .value.listvaadintimebac3ItemList.length,
                        itemBuilder: (context, index) {
                          Listvaadintimebac3ItemModel model = controller
                              .internetPackageSearch1ModelObj
                              .value
                              .listvaadintimebac3ItemList[index];
                          return Listvaadintimebac3ItemWidget(
                            model,
                          );
                        },
                      ),
