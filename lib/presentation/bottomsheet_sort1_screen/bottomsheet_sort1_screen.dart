...
class BottomsheetSort1Screen extends GetWidget<BottomsheetSort1Controller> {
  @override
  ...
  onTapListSort1() {
    Get.toNamed(AppRoutes.bottomsheetSort2Screen);
  }

  onTapListSort2() {
    Get.toNamed(AppRoutes.bottomsheetSort4Screen);
  }
}
